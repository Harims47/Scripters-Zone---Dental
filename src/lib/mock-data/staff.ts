...
export const DEMO_STAFF: Staff[] = [
  ...
  { id: 'STF-108', name: 'Michael Brown', phone: '+91 98765 43217', role: 'Assistant', status: 'Active' },
  { id: 'STF-109', name: 'Jessica Davis', phone: '+91 98765 43218', role: 'Assistant', status: 'Active' },
  { id: 'STF-110', name: 'David Wilson', phone: '+91 98765 43219', role: 'Assistant', status: 'Active' },
  { id: 'STF-111', name: 'Dr. Carter', phone: '+91 98765 43220', role: 'Surgeon', status: 'Active' }
];

export const DEMO_PROVIDERS = DEMO_STAFF.filter(s => 
  s.role === 'Head Doctor' || s.role === 'Duty Doctor' || s.role === 'Surgeon'
);
